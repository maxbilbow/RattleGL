...
//    particle->body.velocity = GLKVector3Add(particle->body.velocity, self.upVector);
}
...
- (GLKVector3)gravityFor:(Particle*)sender {
    return GLKVector3MultiplyScalar(self.upVector,-sender.weight);
}



- (GLKVector3)dragFor:(Particle*)sender{
...
- (GLKVector3)frictionFor:(Particle*)sender {
